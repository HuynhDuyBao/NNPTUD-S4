...
// cau 2
const products = [
  new Product(1, "macbook air M2", 35000000, 10, "Laptops", true),
  new Product(2, "nintendo switch 2", 28000000, 5, "Consoles", true),
  new Product(3, "ps4", 32000000, 3, "Consoles", true),
  new Product(4, "iphone 16", 29000000, 0, "Phones", false),
  new Product(5, "xbox360", 6000000, 15, "Consoles", true),
  new Product(6, "Redmagic", 2500000, 0, "Phones", false)
];
// cau 3
